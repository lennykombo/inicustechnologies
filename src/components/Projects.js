...
const Projects = () => {
  return (
    <div className='min-h-screen px-6 py-6 flex flex-col items-center bg-black'>
      ...
      <div className='flex flex-col md:flex-col lg:flex-row justify-center md:justify-between items-center px-6 py-4 mt-4'>
        <div className='w-full md:w-full lg:w-1/3 border-dotted border-2 flex flex-col p-5 gap-2 rounded-xl border-white m-5 items-center'>
          ...
          <button className="hover:bg-white bg-yellow-500 text-black font-bold py-2 px-4 rounded">
            View Projects
          </button>
        </div>
        <div className='w-full md:w-full lg:w-1/3 border-dotted border-2 flex flex-col p-5 gap-2 rounded-xl border-white m-5 items-center'>
