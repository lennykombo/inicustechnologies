    ...
    <div className='h-screen flex flex-1 w-full items-center justify-center' >
        <div className='flex gap-5 mt-2 ' style={{width:'95%',alignSelf:'center', justifySelf:'center', height:"95%"}}>
            <div className='flex gap-5 bg-white pb-5 shadow-lg'>
                <div className='relative w-1/2 h-full my-10'>
                ...
                <div className='relative justify-center flex w-1/2 h-full my-10'>
                    <div className=' flex flex-col w-full'>
                        <p className='text-4xl text-center leading-10 font-md font-outfit'>About Us</p>
                        <p className='text-lg text-center font-outfit leading-7 px-4 mt-10'>
                        ...
                        <p className='text-lg text-center font-outfit leading-7 px-4 mt-5'>Our mission is clear: to empower businesses and individuals with
                             ...
                             core values of integrity, collaboration, and excellence.</p>
                    </div>
                </div>
            </div>  
        </div>
